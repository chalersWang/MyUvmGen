...
class gen_regmodel_file:
    def __init__(self):
        print("[gen_regmodel_file]:initial")
        #EnvironmentGenCfg='../VerifyEnvironmentGenCfg.xlsx'
        EnvironmentGenCfg=Parameters.EnvironmentGenCfg
        self.gen_regmodel_file_info(EnvironmentGenCfg,PrintEnable=True)
    
    def gen_regmodel_file_info(self,EnvironmentGenCfg,PrintEnable):
        #self.usage()
        self.readexcel_RegModel_info(EnvironmentGenCfg)

        if PrintEnable==True:
            print("Please define the infomation of printing that you need!!!")

    def add_field_info(self,fp, attribute, subbits, field_name, default_val, descript):
    ...
    def gen_ralf(self,fp, sheet, merge):
            ...
            if index[0] > 2:
                ...
                if next_index == (start_index + 1):
                    ...
                    for i in range(next_index - start_index):
                        ...
                        self.add_field_info(fp, attribute, subbits, field_name, default_val, descript)
    ...
    def readexcel_RegModel_info(self,file_name):
...
#   命令行
#   ralgen -t ncc -l sv -uvm -a -c a -B -F -full64 xxx.ral -all_fields_rand -o yyy